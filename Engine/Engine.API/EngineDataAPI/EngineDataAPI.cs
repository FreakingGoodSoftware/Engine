...
{
    public partial class EngineDataAPI : ServiceClient<EngineDataAPI>, IEngineDataAPI
    {
        ...
        /// client pipeline.
        /// </param>
        public EngineDataAPI(params DelegatingHandler[] handlers)
            : base(handlers)
        {
            this._productCategories = new ProductCategories(this);
            this._values = new Values(this);
        ...
        /// client pipeline.
        /// </param>
        public EngineDataAPI(Uri baseUri, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// client pipeline.
        /// </param>
        public EngineDataAPI(ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// client pipeline.
        /// </param>
        public EngineDataAPI(Uri baseUri, ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (baseUri == null)
            {
